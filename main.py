...
class AutoCrawler:
    def __init__(self, skip_already_exist=True, n_threads=4, 
        #do_google=False, 
        do_naver=True, download_path='download',
    ...
    def do_crawling(self):
        ...
        print("Time taken for {} threads to download images is --- {} seconds ".format(_threads, (time.time() - start_time)))
        print('End Program')
...
if __name__ == '__main__':
    ...
    print(
        'Options - skip:{}, threads:{}, naver:{}, full_resolution:{}, face:{}, no_gui:{}, limit:{}, _proxy_list:{}'
            .format(_skip, _threads, 
                #_google, 
                _naver, _full, _face, _no_gui, _limit, _proxy_list))

    crawler = AutoCrawler(skip_already_exist=_skip, n_threads=_threads,
                          #do_google=_google, 
                          do_naver=_naver, full_resolution=_full,
